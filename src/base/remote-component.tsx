...
export type RemoteComponentProps<T extends object = Record<string, any>> = T & Omit<LoadDependProps, 'js' | 'children' | 'component'> & {
  name: string
  js?: string
  css?: string
  jsDeep?: JSDeep
...
export const RemoteComponent: <T extends object = Record<string, any>>(props: RemoteComponentProps<T>) => ReactElement = (props: RemoteComponentProps) => {
